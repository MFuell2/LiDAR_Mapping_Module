...
//    red = digitalRead(RGB_RED);
//    grn = digitalRead(RGB_GRN);
//    blu = digitalRead(RGB_BLU);
...
//    digitalWrite(RGB_GRN, grn);
//    digitalWrite(RGB_BLU, blu);
...
void loop() {
  ...
  //Everything past here is a different version
